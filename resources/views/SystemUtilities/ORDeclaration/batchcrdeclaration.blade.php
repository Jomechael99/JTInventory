                ...
                <div class="box-footer">
                    <div class="row">
                        <div class="form-group col-md-4 pull-right">
                            <button type="button" id="addInvoice" class="form-control btn btn-primary"> Add CR </button>
            ...
            <div class="box">
                ...
                <form method="post" id="batch_form">
                    ...
                    <div class="box box-footer">
                        <div class="form-group col-md-4 pull-right">
                            <button type="button" id="btnAdd" class="form-control btn btn-primary"> Add Batch CR </button>
                            {{--                           <a href="{{ route('SalesInvoice.index') }}" class="form-control btn btn-primary"> Back</a>--}}
                        </div>

        ...
        <section class="content">
                    ...
                    <div class="box-footer">
                        <div class="row">
                            <div class="form-group col-md-4 pull-right">
                                <button type="button" id="addInvoice" class="form-control btn btn-primary"> Add Sales Invoice </button>
            ...
            <div class="box">
                ...
                <div class="box box-footer">
                    <div class="form-group col-md-4 pull-right">
                        <button type="button" id="btnAdd" class="form-control btn btn-primary"> Add Batch Sales Invoice </button>
                        {{--                           <a href="{{ route('SalesInvoice.index') }}" class="form-control btn btn-primary"> Back</a>--}}
                    </div>
